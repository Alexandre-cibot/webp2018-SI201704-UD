        ...
        <div class="wrapper-block flex-container">
            <div>
                <div class="block-p">
                    ...
                    <div class="paragraphe-column">
                    <p>Une charpente est un assemblage de pièces de bois ou de métal, servant à soutenir ou couvrir des constructions et faisant partie de la toiture.
<br><br>
...
<br><br>
Elle constitue un élément important et a pour fonction d’être d’une part une protection contre les intempéries extérieures et d’autre part isolantes. Il existe plusieurs types de toiture :<br><br>
               </p>
               <ul>
                 <li>La toiture en pente
</li>
                 <li>La toiture terrasse</li>
                 <li>Fondations semi-profondes</li>
                 <li>La toiture arrondie
</li>
               </ul>
               </div>              
                </div>
        ...
        <div class="wrapper-block flex-container">
            <div>
                <div class="block-p">
                    ...
                    <div class="paragraphe-column">
                    <p>Le terrassement est une mise en forme du terrain avant la construction. C'est l'ensemble des travaux de fouille, de transport, d'entassement de terre, pratiqués pour modifier le relief d'un terrain permettant de réaliser ou renforcer l'ouvrage de votre future maison.
<br><br>
        ...
        <div class="wrapper-block flex-container">
            <div>
                <div class="block-p">
                    ...
                    <div class="paragraphe-column">
                    <p>L’excavation du terrain est une étape cruciale de la préparation du terrain en vue de la construction de votre maison. Cette étape doit être bien préparée pour être réalisée avec efficacité.
<br><br>
...
<br><br>
	L’excavation se fait au fur et à mesure. Le terrassier peut être amené à utiliser des machines différentes selon zones concernées. Parmi les travaux d’excavation, on peut noter 
               ...
               <ul>
                 <li>le terrassement (le déplacement de la terre d’un endroit à l’autre)</li>
<li>les tranchées (des excavations longues et étroites)</li>
<li>les puits (des excavations verticales ou inclinées profondes)</li>
        ...
        <div class="wrapper-block flex-container">
            <div>
                <div class="block-p">
                    ...
                    <div class="paragraphe-column">
                    <p>Lorsqu'une terrasse recouvre un local, quel qu'il soit petit (grand, habitable, isolé, chauffé, qu'il serve de stockage, qu'il reste simplement clos et couvert, ventilé naturellement ou non), elle joue le rôle de toiture pour ce local, d'où la dénomination de toiture terrasse.
<br><br>
...
Comme pour toute toiture, l'étanchéité est nécessaire. Il faut également éviter la stagnation de l'eau, favoriser son évacuation et lutter contre son imprégnation dans les matériaux. Sans cela l'eau pénètre dans la maison et cause :<br><br>

               </p>
               <ul>
                 <li>des dommages sur sa structure </li>
<li>des dégâts des eaux</li>
<li>des problèmes d'humidité à l'intérieur
</li>
